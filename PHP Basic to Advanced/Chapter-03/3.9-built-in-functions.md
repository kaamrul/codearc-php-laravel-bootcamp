...
|---|---|---|
| [শর্তাধীন/ত্রয়ী অপারেটর (Conditional/Ternary Operator)](3.8-conditional-operators.md) | [হোম](../README.md) | [বিল্ট-ইন ফাংশন এবং ডেটা হ্যান্ডলিং (Built-in Function and Data Handling)](3.9-built-in-functions.md) |
