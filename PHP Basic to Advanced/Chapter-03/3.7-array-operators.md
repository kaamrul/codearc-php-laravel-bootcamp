...
|---|---|---|
| [ স্ট্রিং অপারেটর: কনক্যাটিনেশন বনাম ইন্টারপোলেশন (String operators)](3.6-string-operators.md) | [হোম](../README.md) | [শর্তাধীন/ত্রয়ী অপারেটর (Conditional/Ternary Operator)](3.8-conditional-operators.md) |
