...
|---|---|---|
| [কম্পারিজন বা তুলনামূলক অপারেটর (Comparison Operators)](3.4-comparisaon-operators.md) | [হোম](../README.md) | [স্ট্রিং অপারেটর: কনক্যাটিনেশন বনাম ইন্টারপোলেশন (String operators)](3.6-string-operators.md) |
